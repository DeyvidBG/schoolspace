...
import { schoolSignUpSchema } from "./../../../schema"

interface ISignUpSchoolProps {}

const SignUpSchool: FC<ISignUpSchoolProps> = () => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  } = useForm({ resolver: yupResolver(schoolSignUpSchema) })
  ...
  return (
    <div className={styles.signUpSchool}>
      <FlexBox
